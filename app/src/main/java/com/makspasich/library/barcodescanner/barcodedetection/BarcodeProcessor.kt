...
package com.makspasich.library.barcodescanner.barcodedetection
...
import com.makspasich.library.barcodescanner.InputInfo
import com.makspasich.library.barcodescanner.SettingUtils
import com.makspasich.library.barcodescanner.camera.CameraReticleAnimator
import com.makspasich.library.barcodescanner.camera.FrameProcessorBase
...
class BarcodeProcessor(graphicOverlay: GraphicOverlay, private val workflowModel: WorkflowModel) :
    ...
    override fun onSuccess(
        ...
        if (barcodeInCenter == null) {
            ...
            val sizeProgress = SettingUtils.getProgressToMeetBarcodeSizeRequirement(graphicOverlay, barcodeInCenter)
            if (sizeProgress < 1) {
                ...
                if (SettingUtils.shouldDelayLoadingBarcodeResult()) {
