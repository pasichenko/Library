package com.makspasich.googlebutton.neutral.round
...
val GoogleButton.Neutral.Round.Icon: ImageVector
    get() {
        if (_icon != null) {
            return _icon!!
        }
        _icon = Builder(
            ...
            path(
                ...
                moveTo(20.0f, 0.0f)
                lineTo(20.0f, 0.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, true, 40.0f, 20.0f)
                lineTo(40.0f, 20.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, true, 20.0f, 40.0f)
                lineTo(20.0f, 40.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, true, 0.0f, 20.0f)
                lineTo(0.0f, 20.0f)
