package com.makspasich.googlebutton.neutral.square
...
val GoogleButton.Neutral.Square.Icon: ImageVector
    get() {
        if (_icon != null) {
            return _icon!!
        }
        _icon = Builder(
            ...
            path(
                ...
                moveTo(4.0f, 0.0f)
                lineTo(36.0f, 0.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 40.0f, 4.0f)
                lineTo(40.0f, 36.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 36.0f, 40.0f)
                lineTo(4.0f, 40.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 0.0f, 36.0f)
                lineTo(0.0f, 4.0f)
