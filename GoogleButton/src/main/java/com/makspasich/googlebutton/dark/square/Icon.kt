package com.makspasich.googlebutton.dark.square
...
val GoogleButton.Dark.Square.Icon: ImageVector
    get() {
        if (_icon != null) {
            return _icon!!
        }
        _icon = Builder(
            name = "Icon", defaultWidth = 40.0.dp, defaultHeight = 40.0.dp,
            ...
            path(
                ...
                moveTo(4.0f, 0.5f)
                lineTo(36.0f, 0.5f)
                arcTo(3.5f, 3.5f, 0.0f, false, true, 39.5f, 4.0f)
                lineTo(39.5f, 36.0f)
                arcTo(3.5f, 3.5f, 0.0f, false, true, 36.0f, 39.5f)
                lineTo(4.0f, 39.5f)
